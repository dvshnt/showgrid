...
React.render(
	ShowGrid({day:  initialState.day, range:  initialState.range, venues:  initialState.venues}),
	document.getElementById('showgrid')
);
},{"./components/Showgrid.react":3,"react":153}],2:[function(require,module,exports){
/** @jsx React.DOM */
	...
	render: function() {
		return (
			React.DOM.header(null, 
				React.DOM.a({href: "/"}, 
					React.DOM.span({className: "head--title"}, "SG")
				)
			)
		)
	}
...
module.exports = ShowGrid = React.createClass({displayName: 'ShowGrid',
	...
	render: function() {
		return (
			React.DOM.section({id: "grid--container"}, 
				React.DOM.div({className: "arrow previous", onClick:  this.previousPage}), 
				React.DOM.div({className: "arrow next", onClick:  this.nextPage}), 
				React.DOM.section({id: "grid--fixed--container"}, 
					Header(null), 
					TableHead({
						day:  this.props.day, 
...
},{"../util/GridEngine":154,"./Header.react":2,"./TableBody.react":4,"./TableHead.react":5,"moment":7,"react":153}],4:[function(require,module,exports){
/** @jsx React.DOM */

var React = require('react'),
	moment = require('moment');

module.exports = TableBody = React.createClass({displayName: 'TableBody',
	render: function() {
		var rows = [],
			date = null;
		...
		for (var k = 0; k < this.props.venues.length; k++) {
			...
			var row = [];
			row.push(
				React.DOM.div({className: "venue"}, 
			    	React.DOM.div({className: "pic"}), 
			    	React.DOM.div({className: "name"},  venue.name), 
		    		...
		    		if (date.isSame(showDate)) {
		    			 shows.push(
		    			 	React.DOM.div({className: "show"}, 
					            React.DOM.div({className: "time"},  venue.shows[j].time), 
					        	React.DOM.div({className: "artist"},  venue.shows[j].artist)
					        )
		    			 );
		    		}
		    	}							
			...
			rows.push(
				React.DOM.div({className: "table--row"}, 
					row 
				)
			);
		}
		...
		return (
			React.DOM.section({id: "table--body"}, 
				React.DOM.div({className: "table--body--pad"}), 
				rows 
			)
		)
	}
});
},{"moment":7,"react":153}],5:[function(require,module,exports){
/** @jsx React.DOM */

var React = require('react'),
	moment = require('moment');

module.exports = TableHead = React.createClass({displayName: 'TableHead',
	...
	render: function() {
		...
		for (var i = 0; i < this.props.range; i++) {
			...
			days.push(
				React.DOM.div({className: "cell"}, 
					React.DOM.span(null, date )
				)
			);
		}	

		return (
			React.DOM.div({id: "table--head"}, 
				React.DOM.div({className: "cell"}, 
					React.DOM.span(null, "Venue")
				), 
				days 
			)
		)
...
},{"moment":7,"react":153}],6:[function(require,module,exports){
