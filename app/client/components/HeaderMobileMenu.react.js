		...
		return (
			<div id="header__mobile--menu">
				...
				<section>
					...
					<a href="/#/alerts" className="page alert" onClick={ this.props.selectPage.bind(this, 'alerts') }><b className="icon-bell--full"></b></a>
					<a href="/#/favorites" className="page heart" onClick={ this.props.selectPage.bind(this, 'favorites') }><b className="icon-heart--full"></b></a>
